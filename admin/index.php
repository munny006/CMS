            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        $count_comment = mysqli_query($conn,$sql);

                        $num_post_comment = mysqli_num_rows($count_comment);


                         ?>

                     <div class='huge'><?php echo $num_post_comment;?></div>
                      <div>Comments</div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        $num_post_users = mysqli_num_rows($count_users);


                         ?>


                    <div class='huge'><?php echo $num_post_users;?></div>
                        <div> Users</div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        $count_category = mysqli_query($conn,$sql);

                        $num_category = mysqli_num_rows($count_category);
                    ?>
